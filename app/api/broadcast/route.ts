...
const FALLBACK_STORIES: NewsItem[] = [
  ...
  { id: 'fb6', title: 'Base Network Processes 10 Million Transactions in 24 Hours', summary: 'Coinbase L2 blockchain sets new throughput record as memecoin and DeFi activity surges to all-time highs.', source: 'The Block', category: 'Web3', timestamp: new Date().toISOString(), link: '#' },
  ...
  { id: 'fb10', title: 'Stablecoin Market Cap Hits $200B as USDC Adoption Accelerates', summary: 'Circle USDC leads stablecoin growth on Base and other L2 networks, signaling institutional confidence in on-chain finance.', source: 'The Block', category: 'DeFi', timestamp: new Date().toISOString(), link: '#' },
];
        ...
        messages: [
          {
            role: 'system',
            content:
              'You are a professional AI news anchor for Clanker News Network ($CNN), a crypto and blockchain news channel. Given a headline and summary, provide a brief 2-3 sentence analysis. Be insightful, professional, and slightly dramatic like a real TV anchor. Use phrases like: According to our sources, Our analysis suggests, This is a developing story, Significant implications for the crypto market... 2-3 sentences max.',
          },
          {
            role: 'user',
